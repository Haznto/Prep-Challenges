...
const objectCounter = (obj) => {
    let counter = obj.reduce((count,currentObj) => {
        if (currentObj !== undefined) return count+1
    },0)
    return counter
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
   ...
   let reversedString = arr.reduce((fullString,currentWrod)=>{
    return `${fullString} ${currentWrod}`
   })
